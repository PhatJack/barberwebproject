...
option_items[0].addEventListener("click", function () {
  document.querySelector(".appointment-form").classList.remove("appointment-1");
  document
    .querySelector(".services-container")
    .classList.add("services-container-1");
...
option_items[1].addEventListener("click", function () {
  document.querySelector(".appointment-form").classList.add("appointment-1");
  document
    .querySelector(".services-container")
    .classList.remove("services-container-1");
...
const number_of_customers = {
  ...
  incr_number: function () {
    ...
    if (numb_of_ctms.value < 10) num += 1;
  ...
  time_locking: function () {
    ...
    schedule_box.addEventListener("change", function () {
      ...
      for (let i = 0; i < time_options.length; i++) {
        ...
        if (
          String(schedule_box_value_temp) != arr[0] &&
          String(schedule_box_value_temp) != arr[1] &&
          String(schedule_box_value_temp) != arr[2]
        ) {
...
function booking() {
  ...
  if (a == true && b == true && c == true && d == true && e == true) {
    ...
    document.querySelector(".ctm-name-info").innerHTML =
      "Họ tên: " + customer_class.customer_name;
    document.querySelector(".ctm-phone-numb-info").innerHTML =
      "Số điện thoại: " + customer_class.customer_phone_number;
    document.querySelector(".numb-of-ctms-info").innerHTML =
      "Số khách: " + number_of_customers.number;
    document.querySelector(".branch-select-info").innerHTML =
      "Chi nhánh: " + branch_class.branch;
    document.querySelector(".schedule-info").innerHTML =
      "Ngày đặt lịch: " + schedule_class.schedule;
    document.querySelector(".time-info").innerHTML =
      "Thời gian: " + time_class.time;
    document.querySelector(".note-content-info").innerHTML =
      "Ghi chú: " + note_class.note;
  }
}
function confirm() {
