...
function changeContent(i) {
  let buttonAddProduct = document.querySelector(".add-content input");
  if (i == 0) buttonAddProduct.style.display = "block";
  else buttonAddProduct.style.display = "none";
...
function confirmEditContent(o) {
  ...
  let categoryvalue =
    p.previousElementSibling.querySelector("tr td:nth-child(4)");
  let quantityvalue =
    p.previousElementSibling.querySelector("tr td:nth-child(5)");
...
function confirmEditContentBooking(o) {
  ...
  let customervalue =
    p.previousElementSibling.querySelector("tr td:nth-child(3)");
  let branchvalue =
    p.previousElementSibling.querySelector("tr td:nth-child(4)");
...
function confirmEditContentOrder(o) {
  ...
  // console.log(quantity);
  let usernamevalue =
    p.previousElementSibling.querySelector("tr td:nth-child(1)");
  let phonevalue = p.previousElementSibling.querySelector("tr td:nth-child(2)");
  let product_namevalue =
    p.previousElementSibling.querySelector("tr td:nth-child(3)");
  let quantityvalue =
    p.previousElementSibling.querySelector("tr td:nth-child(4)");
  let addressvalue =
...
function confirmEditContentAccount(o) {
  ...
  let usernamevalue =
    p.previousElementSibling.querySelector("tr td:nth-child(1)");
  let passwordvalue =
    p.previousElementSibling.querySelector("tr td:nth-child(2)");
